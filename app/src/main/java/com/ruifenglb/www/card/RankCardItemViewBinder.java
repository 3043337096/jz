...
public class RankCardItemViewBinder extends ItemViewBinder<VodBean, RankCardItemViewBinder.ViewHolder> implements View.OnClickListener {
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull VodBean item) {
        ...
        if(Data.getQQ().equals("原始蓝")){
            holder.total_view.setBackgroundColor(ColorUtils.getColor(R.color.white));
        }else if(Data.getQQ().equals("暗夜紫")) {
            holder.total_view.setBackgroundColor(ColorUtils.getColor(R.color.xkh));
        }
        ...
        holder.tv_type.setText(vod_class);
        holder.tv_guojia.setText(item.getVod_area());
        holder.tv_year.setText(item.getVod_year());
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(@NonNull View itemView) {
            ...
            tv_guojia = itemView.findViewById(R.id.tv_guojia);
            tv_year = itemView.findViewById(R.id.tv_year);
            tv_desc = itemView.findViewById(R.id.tv_desc);
            tv_count = itemView.findViewById(R.id.tv_count);
            total_view = itemView.findViewById(R.id.total_view);
            if(Data.getQQ().equals("暗夜紫")) {
                tv_type.setTextColor(ColorUtils.getColor(R.color.type));
                tv_guojia.setTextColor(ColorUtils.getColor(R.color.gray_999));
                tv_year.setTextColor(ColorUtils.getColor(R.color.gray_999));
                tv_desc.setTextColor(ColorUtils.getColor(R.color.gray_999));
                tv_count.setTextColor(ColorUtils.getColor(R.color.white));
                ...
                tv_year.setTextColor(ColorUtils.getColor(R.color.gray_999));
                tv_desc.setTextColor(ColorUtils.getColor(R.color.gray_999));
                tv_count.setTextColor(ColorUtils.getColor(R.color.black));
                tv_name.setTextColor(ColorUtils.getColor(R.color.black));
