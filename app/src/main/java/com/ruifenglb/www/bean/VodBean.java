...
//    }
    ...
    public void setVod_sg(String sg) {
        this.vod_sg = sg;
    }
    ...
    public String getVod_pic_thumb() {
        setVod_pic_thumb(getRealPic(vod_pic_thumb));
    ...
    public String getVod_pic_slide() {
        setVod_pic_slide(getRealPic(vod_pic_slide));
...
//        if (!vod_sg.contains("o/")){
//            System.out.println(vod_sg);
//            return "";
//        }
//        if (vod_sg.equals(null) || vod_sg.equals("") ){
//            System.out.println(vod_sg);
//            return "";
//        }
//        String sg = new String(Base64.decode(vod_sg.replaceAll("(o/)|(a/)|(c/)|/","").getBytes(), Base64.DEFAULT));
//
//       if (!sg.endsWith("true")){
//
//           return "";
//       }else {
//           if (!sg.replaceFirst("true$","").equals(ApiConfig.MOGAI_BASE_URL)){
//               return "";
//           }
//       }
//
//        vod_play_url = Rc4.decry_RC4(vod_play_url,vod_sg);
